...
def main(_):
        ...
        with sess2.graph.as_default():
            ...
            if boxes is not None:
                ...
                for i in range(len(boxes)):
                    ...
                    detected_rects[num] = [box[0, 0], box[0, 1], box[1, 0], box[1, 1], box[2, 0], box[2, 1], box[3, 0], box[3, 1]]
                    num += 1
    ...
    img_items = {}
    img_items_normal = {}
    img_text_crop.work_for_array(im_src, detected_rects, img_items, img_items_normal)
